...
#ifndef Cora_Win32_DllNetConn_h
#define Cora_Win32_DllNetConn_h
...
namespace Cora
{
   namespace Win32
   {
      ...
      public:
          ...
          * DLL.
          */
         DllNetConn(HMODULE coralib_module_);
         ...
         /**
          * @return Returns a four byte integer that uniquely identifies this connection.
          */
