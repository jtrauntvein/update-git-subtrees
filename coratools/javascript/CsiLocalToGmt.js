...
function CsiLocalToGmt()
{ }
CsiLocalToGmt.prototype = new CsiExprFunction();
CsiExprToken.add_creator("LocalToGmt", function(){return new CsiLocalToGmt();});

CsiLocalToGmt.prototype.evaluate = function(operands, tokens)
{
