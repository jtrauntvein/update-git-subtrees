...
function CsiInStrRev()
{ }
CsiInStrRev.prototype = new CsiExprFunction();
CsiExprToken.add_creator("InStrRev", function() { return new CsiInStrRev(); });

CsiInStrRev.prototype.evaluate = function(operands, tokens)
{
   if(operands.length < 3)
      throw "InStrRev requires three operands";
   ...
   pos = search.lastIndexOf(pattern, start - 1);
   if(pos >= 0)
      rtn = pos + 1;
