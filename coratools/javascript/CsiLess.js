...
function CsiLess()
{ }
CsiLess.prototype = new CsiExprToken();
CsiExprToken.add_creator("<", function() { return new CsiLess(); });

CsiLess.prototype.get_priority = function()
{ return CsiExprToken.prec_comparator; };

CsiLess.prototype.is_operator = function()
{ return true; };
