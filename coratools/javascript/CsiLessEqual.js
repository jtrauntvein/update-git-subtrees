...
/**
 * Defines an object that implements the <= operator
 */
function CsiLessEqual()
{ }
CsiLessEqual.prototype = new CsiExprToken();
CsiExprToken.add_creator("<=", function() { return new CsiLessEqual(); });

CsiLessEqual.prototype.get_priority = function()
{ return CsiExprToken.prec_comparator; };

CsiLessEqual.prototype.is_operator = function()
{ return true; };

CsiLessEqual.prototype.evaluate = function(operands, tokens)
{
