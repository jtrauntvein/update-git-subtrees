...
namespace Cora
{
   namespace Posix
   {
      ...
      ////////////////////////////////////////////////////////////
      DllNetConn::DllNetConn(void* coralib_module_):
         ...
         identifier(0)
      {
        ...
        send_message_func = (cora_messaging_callback_type)::dlsym(
            coralib_module,
      ...
      DllNetConn::DllNetConn(
         ...
         is_attached(false)
      {
         identifier = reinterpret_cast<uint8>(this);
      ...
      void DllNetConn::attach()
      {
         if(!is_server)
         {
            typedef uint8(__stdcall start_conn_type)(cora_messaging_callback_type, void*);

            start_conn_type* start_conn = (start_conn_type*)::dlsym(
                coralib_module,
            ...
            identifier = start_conn(DllNetConnManager::receive_event, coralib_module);
            if(identifier != 0)
               DllNetConnManager::add_connection(this, coralib_module);
            else
