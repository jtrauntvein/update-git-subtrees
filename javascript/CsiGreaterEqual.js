...
{ }
CsiGreaterEqual.prototype = new CsiExprToken();
CsiExprToken.add_creator(">=", function() { return new CsiGreaterEqual(); });

CsiGreaterEqual.prototype.get_priority = function()
{ return CsiExprToken.prec_comparator; };

CsiGreaterEqual.prototype.is_operator = function()
{ return true; };
