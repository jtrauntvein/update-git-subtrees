...
/**
 * Defines an object that implements the equality operator.
 */
function CsiIsEqual()
{ }
CsiIsEqual.prototype = new CsiExprToken();
CsiExprToken.add_creator("=", function() { return new CsiIsEqual(); });

CsiIsEqual.prototype.is_operator = function()
{ return true; };

CsiIsEqual.prototype.get_priority = function()
{ return CsiExprToken.prec_comparator; };

CsiIsEqual.prototype.evaluate = function(operands, tokens)
{
