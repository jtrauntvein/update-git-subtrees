...
function CsiMaxRunOverTime()
{ this.values = []; }
CsiMaxRunOverTime.prototype = new CsiExprFunction();
CsiExprToken.add_creator("MaxRunOverTime", function(){return new CsiMaxRunOverTime();});

CsiMaxRunOverTime.prototype.evaluate = function(operands, tokens)
{
...
CsiMaxRunOverTime.prototype.reset = function()
{
