...
CsiMinSpa.prototype = new CsiExprFunction();
CsiExprToken.add_creator("MinSpa", function(){return new CsiMinSpa(0);});

CsiMinSpa.prototype.clear_args_count = function()
{ this.args_count = 0; };

CsiMinSpa.prototype.increment_args_count = function()
{ ++this.args_count; };

CsiMinSpa.prototype.evaluate = function(operands, tokens)
{
