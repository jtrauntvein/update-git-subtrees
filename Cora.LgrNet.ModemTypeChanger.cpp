   ...
   namespace LgrNet
   {
      namespace
      {
         ...
         public:
            ...
            // client
            ////////////////////////////////////////////////////////////
            typedef ModemTypeChangerClient client_type;
            client_type *client;
            ...
            // cpost
            ////////////////////////////////////////////////////////////
            static void cpost(ModemTypeChanger *changer, client_type *client, outcome_type outcome)
            {
               event_complete *event = new event_complete(changer, client, outcome);
               event->post();
            }
         ...
         private:
            ...
            // constructor
            ////////////////////////////////////////////////////////////
            event_complete(ModemTypeChanger *changer, client_type *client_, outcome_type outcome_):
         ...
         uint4 const event_complete::event_id(
            Csi::Event::registerType("Cora:::LgrNet::ModemTypeChanger::event_complete"));
      };

      
      ////////////////////////////////////////////////////////////
      // class ModemTypeChanger definitions
      ////////////////////////////////////////////////////////////
      void ModemTypeChanger::receive(Csi::SharedPtr<Csi::Event> &ev)
      {
      ...
      void ModemTypeChanger::on_corabase_ready()
      {
         Csi::Messaging::Message command(net_session, Messages::modem_change_cmd);
      ...
      void ModemTypeChanger::on_corabase_failure(corabase_failure_type failure)
      {
      ...
      void ModemTypeChanger::onNetMessage(
         Csi::Messaging::Router *router, Csi::Messaging::Message *message)
      {
         if(state == state_active)
         {
            if(message->getMsgType() == Messages::modem_change_ack)
            {
               uint4 tran_no;
               uint4 response;
               client_type::outcome_type outcome(client_type::outcome_unknown);
               ...
               case 3:
                  outcome = client_type::outcome_failure_read_only;
                  break;

               case 4:
                  outcome = client_type::outcome_failure_invalid_strings;
                  break;
