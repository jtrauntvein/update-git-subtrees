...
#ifndef Cora_Posix_CoralibLoader_h
#define Cora_Posix_CoralibLoader_h
...
namespace Cora
{
   namespace Posix
   {
      ...
      public:
          ...
          */
         CoralibLoader(char const *dll_name = "");
         ...
         /**
          * @param app_directory Specifies the server application directtory.
          */
      ...
      protected:
         ...
         static void on_server_thread_stop();
