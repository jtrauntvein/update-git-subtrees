...
#ifndef Csi_Win32_FileSystemObject_h
#define Csi_Win32_FileSystemObject_h
...
namespace Csi
{
   namespace Win32
   {
      ...
      /**
       * Defines an object that represents information about a file volume on the host machine.
       */
      class FileVolume
      {
      private:
         /**
          * Specifies the name of the file volume.
          */
         StrAsc name;

         /**
          * Specifies the type of file volume object.
          */
      public:
         enum volume_type
         {
      ...
      public:
          ...
          * Constructor
          *
          * @param name_ Specifies the name of the file volume.
          */
         FileVolume(char const *name_);

         /**
          * @return Returns the name of the file object.
          */
         StrAsc const &get_name() const
         { return name; }

         /**
          * @return Returns a string that represents the volume type.
          */
         char const *get_type_string() const;

         /**
          * @return Returns a code that represents the volume type.
          */
         volume_type get_type() const
         { return type; }

         /**
          * Looks up the storage limits on the volume and returns them in the reference parameters.
          *
          * @param volume_size Specifies a reference to which the volume size in bytes will be
          * written,
          *
          * @param volume_free Specifies a reference to which the volume free space in bytes will be
          * written.
          */
         void get_volume_limits(
            int8 &volume_size,
            int8 &volume_free);
      };
      ...
      /**
       * Generates the list of all file volumes known on the host computer.
       */
