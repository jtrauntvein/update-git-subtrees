/* Cora.Sec2.AccountChanger.cpp
   ...
   Last Change: Monday 07 October 2019
...
#include "Cora.Sec2.AccountChanger.h"
   ...
   namespace Sec2
   {
      namespace
      {
         ...
         uint4 const event_complete::event_id =
            Csi::Event::registerType("Cora::Sec2::AccountChanger::event_complete");
      };
      ...
      void AccountChanger::describe_outcome(
         std::ostream &out, client_type::outcome_type outcome)
      {
         using namespace AccountChangerStrings;
         switch(outcome)
         {
         ...
         case client_type::outcome_invalid_account_name:
            out << my_strings[strid_outcome_failure_invalid_account_name];
            break;
      ...
      void AccountChanger::on_sec2base_ready()
      {
         Csi::Messaging::Message command(sec2_session,Messages::change_account_cmd);
      ...
      void AccountChanger::on_sec2base_failure(sec2base_failure_type failure)
      {
      ...
      void AccountChanger::onNetMessage(
         Csi::Messaging::Router *rtr,
         Csi::Messaging::Message *msg)
      {
         if(state == state_active)
         {
            if(msg->getMsgType() == Messages::change_account_ack)
            {
               uint4 tran_no;
      ...
      void AccountChanger::receive(Csi::SharedPtr<Csi::Event> &ev)
      {
